...
model_path <- paste0(drive_path, "tutorial1/")
...
# mcmc
fit <- rstan::stan(file = paste0(model_path, 'tutorial1_model1.stan'), 
                   data = stan_data,
                   iter = warmup + iter, 
                   chains = chains,
                   warmup = warmup, 
...
# mcmc
fit_model1 <- rstan::stan(file = paste0(model_path,'tutorial1_model1bis.stan'), 
                   data = stan_data,
                   iter = warmup + iter, 
                   chains = chains,
                   warmup = warmup, 
...
# mcmc
fit_model2 <- rstan::stan(file = paste0(model_path,'tutorial1_model2.stan'), 
...
saveRDS(fit_model2, paste0(output_path, 'tutorial1_model2_fit.rds'))
