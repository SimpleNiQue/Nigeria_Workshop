...
model_path <- paste0(drive_path, "tutorial2/")
...
# mcmc
fit1 <- rstan::stan(file = paste0(model_path, 'tutorial2_model1.stan'), 
...
# mcmc
fit2 <- rstan::stan(file = paste0(model_path, 'tutorial2_model2.stan'), 
                   data = stan_data_model1,
                   iter = warmup + iter, 
                   chains = chains,
                   warmup = warmup, 
...
fit_tuto1_model2 <- readRDS(paste0(output_path, 'tutorial1_model2_fit.rds'))
...
# mcmc
fit3 <- rstan::stan(file = paste0(model_path, 'tutorial2_model3.stan'), 
...
saveRDS(fit3, paste0(output_path, 'tutorial2_model3_fit.rds'))
